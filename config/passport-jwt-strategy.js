...
let opts = {
    ...
    secretOrKey: 'collezblog' // encryption and decryption string 
...
passport.use(new JWTStrategy(opts,function(jwtPayLoad,done){ //payload conatains the info of the user, done is a callback function
